...
public class DemoCommand1 {
    ...
    public String invoke1(Integer number, Integer maxIter, String message, String invoked) {
...
//                    source = "https://demo-app2/start?invoked=false&number=2";
//                    response = restTemplate.getForObject(source, String.class) + "<br>";

                sb.append(restTemplate.getForObject("https://demo-app2/start?invoked=false", String.class) + "<br>");
                sb.append(restTemplate.getForObject("https://demo-app3/start?invoked=false", String.class) + "<br>");
                sb.append(restTemplate.getForObject("https://demo-app4/start?invoked=false", String.class) + "<br>");
                //}
            }
    ...
    public String fallback1(Integer number, Integer maxIter, String message, String invoked) {
        StringBuffer sb = new StringBuffer();
