...
public class DemoCommand2 {
    ...
    public String invoke2(Integer number, Integer maxIter, String message, String invoked) {
        ...
        /*
            if (b) {
                ...
                //if (Math.abs(rand - my) > 0) {
                    ...
                    source = "https://demo-app3/start?invoked=false&number=2";
...
//        }
    ...
    public String fallback2(Integer number, Integer maxIter, String message, String invoked) {
        StringBuffer sb = new StringBuffer();
